(function (e) {
    ...
    r.Session = class extends l {
        ...
        consume(e) {
            if (console.log('consuming', e), this._before_consume(e), this._aborted) throw new r.Error('already_aborted');
        ...
        _parse_and_consume_header() {
            ...
            if (e) return console.debug('RECEIVED HEADER:', e[0]), this._consume_header(e[0]), this._last_header_name = e[0].NAME, this._last_header_crc = e[1], e[0]
        }
        ...
        _send_header() {
            ...
            console.log(this.type, 'SENDING HEADER', _[1]), this._sender(_[0]), console.debug('SENT HEADER:', _[1]), this._last_sent_header = _[1]
        }
    ...
    r.Session.Send = class extends r.Session {
        ...
        _send_header_and_data(e, _, n) {
            ...
            t[0].push.apply(t[0], r), console.log(this.type, 'SENDING HEADER', t[1]), this._sender(t[0]), this._last_sent_header = t[1]
        }
    ...
    function t(e) {
        if (!E[e]) throw new c.Error('Invalid ZRINIT flag: ' + e);
        return E[e]
    }
    ...
    const E = {CANFDX: 1, CANOVIO: 2, CANBRK: 4, CANCRY: 8, CANLZW: 16, CANFC32: 32, ESCCTL: 64, ESC8: 128};
    ...
    class I extends c.Header {
        ...
        can_full_duplex() {
            return !!(this._bytes4[3] & E.CANFDX)
        }

        can_overlap_io() {
            return !!(this._bytes4[3] & E.CANOVIO)
        }

        can_break() {
            return !!(this._bytes4[3] & E.CANBRK)
        }

        can_fcs_32() {
            return !!(this._bytes4[3] & E.CANFC32)
        }

        escape_ctrl_chars() {
            return !!(this._bytes4[3] & E.ESCCTL)
        }

        escape_8th_bit() {
            return !!(this._bytes4[3] & E.ESC8)
        }
    }
    ...
    const B = [[Z, 'ZRQINIT'], [I, 'ZRINIT'], [C, 'ZSINIT'], [v, 'ZACK'], [O, 'ZFILE'], [A, 'ZSKIP'], void 0, [L, 'ZABORT'], [T, 'ZFIN'], [D, 'ZRPOS'], [M, 'ZDATA'], [F, 'ZEOF'], [R, 'ZFERR'], void 0, void 0, void 0, void 0, void 0, void 0, void 0];
    for (var H = {}, z = 0; z < B.length; z++) B[z] && (H[B[z][1]] = B[z][0], Object.assign(B[z][0].prototype, {
        TYPENUM: z,
        NAME: B[z][1]
    }));
    const j = [Z, I, C, v, O, A, 'ZNAK', L, T, D, M, F, R, 'ZCRC', 'ZCHALLENGE', 'ZCOMPL', 'ZCAN', 'ZFREECNT', 'ZCOMMAND', 'ZSTDERR'];
